...
\begin{frame}
    ...
    from beginer to proficient. If you'd like to learn more about Python, please go for \hyperlink{fm_resources}{\color{YellowGreen}these} resources.
    \bigbreak
    \pause
...
\begin{frame}
    ...
    ODE and PDE are equations that the solutions are a function(precisely, a family of functions). As their names indicating, ODE contains
...
\begin{frame}
    ...
    You might want to get an analytical solution of an ODE or PDE. Usually it's possible only in homework, and impractical when
