...
So first is, still, the comments. You can see that these texts are bounded by a pair
of slash and asterisk. This is the multi-line comment. Such comment is suitable for
explanation at the begining of the source codes. You also can have a single line comment,
which starts with double slash:
*/
